...
import type { Metadata } from 'next'; // <-- IMPORTANTE: Adicione esta linha

// ADICIONE ESTA BLOCO DE CÓDIGO ANTES DO COMPONENTE HOME
// Ele exporta metadados específicos para esta página, sobrescrevendo os do layout.
export const metadata: Metadata = {
  ...
  openGraph: { // Metadados para compartilhamento no Facebook, LinkedIn, etc.
    ...
    images: [
      { 
        url: 'https://i.imgur.com/eWcADeW.jpeg', // Use uma imagem de alta qualidade da fachada
        width: 1200,
        height: 630,
